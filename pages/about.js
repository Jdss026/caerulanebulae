  ...
  return (
    <>
      <PageSeo
        ...
        description={`Sobre mim - ${siteMetadata.author}`}
      ...
      <div className="divide-y">
        ...
        <div className="items-start space-y-2 xl:grid xl:grid-cols-3 xl:gap-x-8 xl:space-y-0">
          <div className="flex flex-col items-center pt-8 space-x-2">
            ...
            <div className="text-gray-500 dark:text-gray-400">Aspirante a Físico</div>
            <div className="text-gray-500 dark:text-gray-400">UFMA</div>
